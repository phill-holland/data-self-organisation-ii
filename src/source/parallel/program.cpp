...
void organisation::parallel::program::insert(int epoch)
{
    ...
    if(count > 0)
    {
        ...
        impacter->search(inserter->deviceNewPositions, inserter->deviceNewClient, deviceCollisionKeys, count, false, false, false, NULL, 0, queue, false);
